export const friendsPosts = () => async (dispatch) => {
    try {
        ...
        let data = await fetch("http://localhost:4000/friends/posts")
...
export const createPost = (caption, image) => async (dispatch) => {
    try {
        ...
        let data = await fetch("http://localhost:4000/upload/post", {
            method: "POST",
            headers: {
...
export const likePosts = (id) => async (dispatch) => {
    try {
        ...
        let data = await fetch(`http://localhost:4000/post/like/${id}`, {
            method: "POST"
        })
        data = await data.json()
        if (data.success) {
...
export const commentOnPost = (id, comment) => async (dispatch) => {
    try {
        ...
        let data = await fetch(`http://localhost:4000/post/comment/${id}`, {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
...
export const deleteComment = (id, commentId) => async (dispatch) => {
    try {
        ...
        let data = await fetch(`http://localhost:4000/comment/delete/${id}`, {
            method: "DELETE",
            headers: {
                "Content-Type": "application/json"
            },
...
export const myPosts = () => async (dispatch) => {
    try {
        ...
        let data = await fetch(`http://localhost:4000/my/posts`)
        data = await data.json()
        if (data.success) {
...
export const userPosts = (id) => async (dispatch) => {
    try {
        ...
        let data = await fetch(`http://localhost:4000/user/posts/${id}`)
        data = await data.json()
        if (data.success) {
...
export const deleteMyPost = (id) => async (dispatch) => {
    try {
        ...
        let data = await fetch(`http://localhost:4000/post/${id}`, {
            method: "DELETE"
        })
        data = await data.json()
        if (data.success) {
...
export const updatePostCaption = (id, caption) => async (dispatch) => {
    try {
        ...
        let data = await fetch(`http://localhost:4000/post/update/caption/${id}`, {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
