    ...
    return <div className="Login">
        <div className="content">
            <div className="left-content">
                <Typography variant="h2" style={{ color: "#1976d2", fontWeight: "bold" }}>facebook</Typography>
                <Typography variant="h5">Facebook helps you connect and  share with <br /> the people in your life.</Typography>
            </div>
